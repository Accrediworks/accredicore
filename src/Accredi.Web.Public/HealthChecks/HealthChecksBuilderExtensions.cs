...
namespace Accredi.Web.Public.HealthChecks;

public static class HealthChecksBuilderExtensions
{
    public static void AddAccrediPublicHealthChecks(this IServiceCollection services)
    {
        ...
        {
            settings.AddHealthCheckEndpoint("Accredi Public Health Status", healthCheckUrl);
        });
