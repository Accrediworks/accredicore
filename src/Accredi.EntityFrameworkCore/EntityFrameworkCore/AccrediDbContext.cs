...
public class AccrediDbContext :
    AbpDbContext<AccrediDbContext>,
    ISaasDbContext,
    IIdentityProDbContext
{
    ...
    public AccrediDbContext(DbContextOptions<AccrediDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(AccrediConsts.DbTablePrefix + "YourEntities", AccrediConsts.DbSchema);
