...
{
    [DbContext(typeof(AccrediDbContext))]
    [Migration("20250426202930_CRMInitial")]
    partial class CRMInitial
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Accredi.Crm.AccountLocations.AccountLocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("CrmAccountLocations", (string)null);
                });

            modelBuilder.Entity("Accredi.Crm.Accounts.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CrmAccounts", (string)null);
                });

            modelBuilder.Entity("Accredi.Crm.ContactAccounts.ContactAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ContactLevelId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ContactLevelId");

                    b.ToTable("CrmContactAccounts", (string)null);
                });

            modelBuilder.Entity("Accredi.Crm.ContactEmails.ContactEmail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CrmContactEmails", (string)null);
                });

            modelBuilder.Entity("Accredi.Crm.ContactLevels.ContactLevel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CrmContactLevels", (string)null);
                });

            modelBuilder.Entity("Accredi.Crm.ContactStates.ContactState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CrmContactStates", (string)null);
                });

            modelBuilder.Entity("Accredi.Crm.ContactTelephones.ContactTelephone", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CrmContactTelephones", (string)null);
                });

            modelBuilder.Entity("Accredi.Crm.Contacts.Contact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ContactStateId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("NationalIdentifier")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("NationalIdentifier");
            ...
            modelBuilder.Entity("Accredi.Crm.Countries.Country", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CrmCountries", (string)null);
                });
            ...
            modelBuilder.Entity("Accredi.Crm.AccountLocations.AccountLocation", b =>
                {
                    b.HasOne("Accredi.Crm.Accounts.Account", null)
                        .WithMany("AccountLocations")
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Accredi.Crm.Countries.Country", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Accredi.Crm.ContactAccounts.ContactAccount", b =>
                {
                    ...
                    b.HasOne("Accredi.Crm.Contacts.Contact", null)
                        .WithMany("ContactAccounts")
                        .HasForeignKey("ContactId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Accredi.Crm.ContactLevels.ContactLevel", null)
                        .WithMany()
                        .HasForeignKey("ContactLevelId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Accredi.Crm.Contacts.Contact", b =>
                {
                    b.HasOne("Accredi.Crm.ContactStates.ContactState", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Accredi.Crm.Contacts.Contact", b =>
                {
                    ...
                    b.Navigation("ContactTelephones");
                });
