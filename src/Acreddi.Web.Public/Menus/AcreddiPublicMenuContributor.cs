...
namespace Acreddi.Web.Public.Menus;

public class AcreddiPublicMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public AcreddiPublicMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                AcreddiPublicMenus.ArticleSample,
