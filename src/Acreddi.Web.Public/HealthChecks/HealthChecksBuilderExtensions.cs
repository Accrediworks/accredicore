...
namespace Acreddi.Web.Public.HealthChecks;

public static class HealthChecksBuilderExtensions
{
    public static void AddAcreddiPublicHealthChecks(this IServiceCollection services)
    {
        ...
        {
            settings.AddHealthCheckEndpoint("Acreddi Public Health Status", healthCheckUrl);
        });
