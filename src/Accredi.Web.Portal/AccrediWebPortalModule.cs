...
public class AccrediWebPortalModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                ...
                typeof(AccrediWebPortalModule).Assembly
            );
        });
    }
    ...
    {
        Configure<RedisCacheOptions>(options => { options.Configuration = configuration["RedisConfiguration"]; });
    }
    ...
    {
        Configure<AbpAutoMapperOptions>(options => { options.AddMaps<AccrediWebPortalModule>(); });
    }
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<AccrediWebPortalModule>();
            ...
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<AccrediWebPortalModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
