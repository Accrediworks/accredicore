...
{
    public static void AddAcreddiAuthServerHealthChecks(this IServiceCollection services)
    {
        ...
        {
            settings.AddHealthCheckEndpoint("Acreddi AuthServer Health Status", healthCheckUrl);
        });
