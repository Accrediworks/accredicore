...
{
    public static void AddAccrediAuthServerHealthChecks(this IServiceCollection services)
    {
        ...
        {
            settings.AddHealthCheckEndpoint("Accredi AuthServer Health Status", healthCheckUrl);
        });
